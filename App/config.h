...
#if CONFIG_VISION_ADJUST_MODE != CONFIG_VISION_ADJUST_MODE_SEQUENTIAL && \
    CONFIG_VISION_ADJUST_MODE != CONFIG_VISION_ADJUST_MODE_SIMULTANEOUS
#error "Invalid CONFIG_VISION_ADJUST_MODE"
#endif

#define CONFIG_VISION_ADJUST_KP_X            0.5f
#define CONFIG_VISION_ADJUST_KP_Y            -0.5f
#define CONFIG_VISION_ADJUST_DEADZONE        10.0f
#define CONFIG_VISION_ADJUST_RPM_LIMIT       30.0f
...
#define CONFIG_VISION_ADJUST_STABLE_TIME_MS  500U

/* 三个作业区域对应的绝对车头方向。Raw 使用非零值以生成旋转命令。 */
#define CONFIG_CHASSIS_RAW_HEADING_DEG     0.01f
#define CONFIG_CHASSIS_ROUGH_HEADING_DEG 180.0f
#define CONFIG_CHASSIS_TEMP_HEADING_DEG   90.0f

/* 6号升降电机的四档取放高度（相对顶部安全位的下降脉冲）。 */
#define CONFIG_GIMBAL_LIFT_GROUND_PULSES     210000L
#define CONFIG_GIMBAL_LIFT_CAR_PULSES        140000L
#define CONFIG_GIMBAL_LIFT_TURNTABLE_PULSES  100000L
#define CONFIG_GIMBAL_LIFT_STACK_PULSES      90000L
#define CONFIG_GIMBAL_LIFT_GROUND_WAIT_MS     3000U
...
#define CONFIG_GIMBAL_ROTATE_WAIT_MS           2000U
#define CONFIG_GIMBAL_GRIPPER_WAIT_MS          200U
#define CONFIG_GIMBAL_EXTEND_CAR_WAIT_MS      1000U
#define CONFIG_GIMBAL_EXTEND_MAP_WAIT_MS       500U
...
#define CONFIG_GIMBAL_CAR_RETRACT_PULSES       5000L
...
/* 车体物料放置位置对应的云台角度（度）。 */
#define CONFIG_CAR_MATERIAL_POS_1_DEG  -6.5f
#define CONFIG_CAR_MATERIAL_POS_2_DEG  CONFIG_CAR_MATERIAL_POS_1_DEG-30.0f
#define CONFIG_CAR_MATERIAL_POS_3_DEG  CONFIG_CAR_MATERIAL_POS_1_DEG-65.0f

/* 地图物料放置位置对应的云台角度（度）。 */
#define CONFIG_MAP_MATERIAL_POS_1_DEG  90
#define CONFIG_MAP_MATERIAL_POS_2_DEG  135
#define CONFIG_MAP_MATERIAL_POS_3_DEG  150
