...
#define CONFIG_GIMBAL_CAR_RETRACT_PULSES       6000L
...
#define CONFIG_CAR_MATERIAL_POS_2_DEG  CONFIG_CAR_MATERIAL_POS_1_DEG-32.5f
#define CONFIG_CAR_MATERIAL_POS_3_DEG  CONFIG_CAR_MATERIAL_POS_1_DEG-75.0f
